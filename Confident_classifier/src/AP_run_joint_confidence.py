...
parser.add_argument('--dataset', default='kitti', help='kitti | nusce')
...
train_loader, test_loader = AP_data_loader.getTargetDataSet(args.dataset, args.batch_size, args.imageSize, args.dataroot)
